...
from DRAGON import call_py, DRAGON, client as Client
owner = "5972336720"
from DRAGON.helpers.yt_dlp import bash
from DRAGON.helpers.chattitle import CHAT_TITLE
from DRAGON.helpers.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
from DRAGON.helpers.thumbnail import gen_thumb
...
@DRAGON.on(events.callbackquery.CallbackQuery(data="cls"))
async def _(event):
